...
def test_combines_dicts_correctly_for_single_forecast():
    test_input = {"city": {"lat": 1, "lon": 2}, "list": [{"pressure": 3, "temp": 4}]}
...
def test_combines_dicts_correctly_for_multiple_forecasts():
    test_input = {
        "city": {"lat": 1, "lon": 2},
        "list": [{"pressure": 3, "temp": 4}, {"pressure": 5, "temp": 6}],
    }

    result = format_data(test_input)

    expected = [
        {"lat": 1, "lon": 2, "pressure": 3, "temp": 4},
...
def test_for_more_nested_levels():
    test_input = {
        "city": {"lat": 1, "lon": 2},
        "list": [
            {"pressure": 3, "temp": 4, "clouds": {"all": 100}},
    ...
    expected = [
        {"lat": 1, "lon": 2, "pressure": 3, "temp": 4, "clouds.all": 100},
